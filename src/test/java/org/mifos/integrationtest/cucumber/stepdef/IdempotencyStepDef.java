...
public class IdempotencyStepDef extends BaseStepDef {
    ...
    public void iCallCollectionApiWithClientCorrelationIdExpectedStatus(int expectedStatus) throws JSONException {
        ...
        String json = RestAssured.given(requestSpec)
                ...
                .when()
                .post(channelConnectorConfig.collectionEndpoint)
                .andReturn().asString();
    ...
    public void iHaveSameClientCorrelationId() {
        if (BaseStepDef.clientCorrelationId == null || BaseStepDef.clientCorrelationId.isEmpty()) {
            BaseStepDef.clientCorrelationId = "123";
        }
    ...
    public void iCallGsmaTransactionToFailWithClientCorrelationIdExpectedStatus(int status)
    ...
    public void iCallInboundTransferReqApiWithClientCorrelationIdExpectedStatus(int expectedStatus) {
        ...
        BaseStepDef.response = RestAssured.given(requestSpec)
                ...
                .spec(new ResponseSpecBuilder().expectStatusCode(expectedStatus).build())
                .when()
                .post(channelConnectorConfig.transferReqEndpoint)
                .andReturn().asString();
