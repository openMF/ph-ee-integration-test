...
public class GSMATransferHelper {
    ...
    public GSMATransaction gsmaTransactionRequestBodyHelper(String amount, GsmaParty payer, GsmaParty payee, String currency, String requestingOrganisationTransactionReference, String originalTransactionReference,
                                                             String subType, String type, String descriptionText, Fee fees, String geocCode,
                                                             InternationalTransferInformation internationalTransferInformation, String oneTimeCode,
                                                             Kyc receiverKyc, Kyc senderKyc, String servicingIdentity, String requestDate) throws JSONException {
    ...
    public InternationalTransferInformation internationalTransferInformationHelper(String quotationReference,String quoteId, String deliveryMethod, String originCountry,
                                                                                   String receivingCountry, String relationshipSender, String remittancePurpose){
    ...
    public IdDocument idDocumentHelper (String idType,String idNumber, String issuerCountry, String expiryDate, String issueDate,String issuer, String issuerPlace){
    ...
    public PostalAddress postalAddressHelper(String addressLine1, String addressLine2, String addressLine3, String city, String country, String postalCode, String stateProvince){
    ...
    public Kyc kycHelper(String birthCountry, String dateOfBirth, String contactPhone, String emailAddress, String employerName, char gender,IdDocument idDocument, String nationality, String occupation, PostalAddress postalAddress, SubjectName subjectName){
        Kyc kyc = new Kyc();
