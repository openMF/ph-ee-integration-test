...
Feature: Batch Details API test
  ...
  Scenario: Ensure minimum throttle time for sub-batches
    Given The system has a configured throttle time of 30 seconds and sub-batch size of 5
    And I have the demo csv file "ph-ee-bulk-demo-6.csv"
    ...
    And I am able to parse batch transactions response
    And I fetch batch ID from batch transaction API's response
    Then I call the transfer API for requestIds fetched with expected status of 200
